...
| Short form | UOK DRS |
| Footer attribution | Developed by Department of Industrial Management, Faculty of Science, University of Kelaniya |
| Logo icon | Lucide `Activity` icon on amber (#f59e0b) 32px rounded square |
| Primary font | Inter |
| No playful branding | No AI-generated names, no taglines, no mascots, no AI emojis just premium aqnimate icons  |
